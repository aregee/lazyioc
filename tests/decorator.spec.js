...
new function(o) {
    ...
    describe('AppShell#decorator', function() {
        it('will add a decorator for every provider if no key is passed', function() {
            ...
            appShell.service('Thing', function() { this.name = 'Thing'; });
            appShell.service('Prop', function() { this.name = 'Prop'; });
        ...
        it('can handle dot notation keys', function() {
            let appShell = new AppShell('decorator');
            appShell.service('Util.Thing', function() { this.name = 'Util Thing'; });
        ...
        it('will decorate deeply nested services', function() {
            let appShell = new AppShell('decorator');
            appShell.service('Util.A.B.C.Thing', function() { this.name = 'Util'; });
            appShell.decorator('Util.A.B.C.Thing', function(Service) {
                Service.name = 'Util Deep FooBar';
                return Service;
            });
            expect(appShell.container.Util.A.B.C.Thing.name).equals('Util Deep FooBar');
        });
    ...
    describe('container#$decorator', function() {
        it('will add a decorator for every provider if no key is passed', function() {
            let appShell = new AppShell('decorator');
            appShell.service('ns.Thing', function() { this.name = 'Thing'; });
            appShell.service('ns.Prop', function() { this.name = 'Prop'; });
        ...
        it('can handle dot notation keys', function() {
            let appShell = new AppShell('decorator');
            appShell.service('ns.Util.Thing', function() { this.name = 'Util Thing'; });
        ...
        it('will decorate deeply nested services', function() {
            let appShell = new AppShell('decorator');
            appShell.service('ns.Util.A.B.C.Thing', function() { this.name = 'Util'; });
            appShell.container.ns.$decorator('Util.A.B.C.Thing', function(Service) {
                Service.name = 'Util Deep FooBar';
                return Service;
            });
            expect(appShell.container.ns.Util.A.B.C.Thing.name).equals('Util Deep FooBar');
        });
    });
