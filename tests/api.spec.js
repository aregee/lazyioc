...
new function(o) {
  ...
  clone.spec("lazyioc API", function() {
    ...
    clone(
      "expect appShell to have a global property object 'config' ",
      function() {
        clone(typeof appShell.config === "object").equals(true)(
    ...
    clone(
      "expect appShell to expose a instanceFactory which is a function",
      () => {
