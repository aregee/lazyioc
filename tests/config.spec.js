...
new function(o) {
	...
	clone.spec("lazyioc config", function() {
        ...
        clone('expect container to be instance of AppShell', function() {
			...
			clone(appShellInstance instanceof AppShell).equals(true)('Should be true');
        });

        clone("expect to create new instance even if called  with same name", function() {
            /* jshint newcap: false */
        ...
        clone.spec('Provide a singleton intance forEach case', () => {
            ...
            clone('expect to return new module if appShellInstance.module is invoked ', () => {
            ...
            clone('expect to return same module if appShellInstance.module is invoked with already exsting module name', () => {
                clone(instance.module('one')).equals(instance.module('one'))('should not be a new instance');
                /* jshint newcap: true */
            });
            clone('will not return the same instance with the same name after #clear', function() {
            ...
            clone('will return the same instance when another named instance is cleared', function() {
            ...
            clone('will make the instance name available when a name is passed', function() {
                let childInst = instance.module('Baz');
            clone(childInst.container.CONTAINER_NAME).equals('Baz');
            });
            clone('will return the same instance when a name is passed, even if the string == false', function() {
